...
var types = require('../../../dist/binary/types'),
  Data = require('../../../dist/binary/Data').Data,
  should = require('should'),
  ReadState = require('../../../dist/binary/ReadState').ReadState,
...
describe('types', function () {
  ...
  it('should be sound for Buffer', function () {
    check(types._Buffer, new Buffer([]))
    check(types._Buffer, new Buffer([3, 14, 15, 92, 65, 35]))
  })
